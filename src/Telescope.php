...
class Telescope
{
    ...
    {
        if ((! config('telescope.enabled')) || config('telescope.enviroment') == 'dev') {
            return;
        }
     ...
     *
     * @param  string  $type
     * @param  \Aqayepardakht\Logger\IncomingEntry  $entry
     * @return void
     */
     ...
     *
     * @param  \Aqayepardakht\Logger\EntryUpdate  $update
     * @return void
     */
     ...
     *
     * @param  \Aqayepardakht\Logger\Contracts\EntriesRepository  $storage
     * @return void
     */
