...
namespace Aqayepardakht\Logger\Storage;

use DateTimeInterface;
use Aqayepardakht\Logger\Curl;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\DB;
use Aqayepardakht\Logger\EntryType;
...
use Aqayepardakht\Logger\Contracts\TerminableRepository;
use Aqayepardakht\Logger\Contracts\EntriesRepository as Contract;
...
class DatabaseEntriesRepository implements Contract, ClearableRepository, PrunableRepository, TerminableRepository
{
     ...
     *
     * @param  \Aqayepardakht\Logger\IncomingEntry  $exception
     * @return int
     */
    ...
    public function store(Collection $entries)
    {
        ...
        \Aqayepardakht\Logger\Jobs\SendLog::dispatchNow($entries); 
    }

    /**
     * Store the given array of exception entries.
     *
     * @param  \Illuminate\Support\Collection|\Aqayepardakht\Logger\IncomingEntry[]  $exceptions
     * @return void
     */
     ...
     *
     * @param  \Aqayepardakht\Logger\EntryUpdate  $entry
     * @return void
     */
